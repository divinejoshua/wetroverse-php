...
$pageHome = "";
$pageFollowing ="";
$pageDiscover = "active text-danger";
$pageNotification ="";
include ('header.php');
?>

<title>Discover · Wetroverse</title>
<main class="container" id="mainContent" style="max-width: 600px; margin-top: 20px;">
  <div class="time nav-scroller d-flex align-items-center p-3 my-3 text-dark-50 bg-white rounded shadow" style="height: 40px;">
      <form class="d-flex" style="width: 100%;" method="GET" action="search">
        <input class="form-control searchbox" name="searchbox" type="search" placeholder="Search Wetroverse" aria-label="Search" style=" border:none;"<?php if(isset($_GET['searchbox'])){echo"value ='".$_GET['searchbox']."' ";}?>>
