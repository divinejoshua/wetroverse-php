...
<nav class="navbar navbar-expand-lg fixed-top navbar-light bg-white border-bottom">
  <div class="container-fluid in-nav">
   <button class="navbar-toggler p-0 border-0" type="button">
     <a href="home" class="text-muted"><i class="fas fa-home"></i></a> 
    </button>
...
<div class="nav-scroller bg-white text-center border-bottom border-top header-profile" style="position: fixed; top:50px; width: 100%; z-index: 1020;"><center>
  <nav class="nav nav-underline text-white nav-pills" style="max-width: 600px;">
   <a class="nav-link"href="javascript:history.back()"><b> <i class="fas fa-arrow-left"></i> &nbsp; &nbsp;<?php echo"$pageName";?> </b> &nbsp;<?php echo "$verifyTick"; ?></a>
  </nav>
  </center>
</div>
<br>
...
<div class="container" style="max-width: 1250px; padding: 0px;">
  ...
  <div class="panel-menu pt-4" style="width: 300px;">
...
<div class="d-flex">
  ...
  <a href='addpost<?php echo"$addPost"; ?>' type="button" class=" nav-link btn btn-primary btn-block btn-lg btn-sm mt-3 mr-3 border" style="height: 40px;"><i class="fas fa-edit"></i> Add post</a></div>
</div>
  ...
  <div class="panel-menu-right pt-4" style="width: 300px;">
